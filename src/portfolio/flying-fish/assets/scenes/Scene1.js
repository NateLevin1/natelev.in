...
class Scene1 extends Phaser.Scene {
	...
	lose(force = false) {
		if((!force && death == "die") || force) {
			...
			this.add.text(735/2, 400, -this.score, {fontSize: '100px', fill: '#fff', fontFamily: '"Arial"', stroke: "#000", strokeThickness: 10 }).setOrigin(0.5, 0).setDepth(100).setScrollFactor(0);
