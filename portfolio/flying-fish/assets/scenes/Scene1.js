...
class Scene1 extends Phaser.Scene {
	...
	create() {
		...
		this.score = 0;
		this.scoreText = this.add.text(650, 955, this.score, {fontSize: '36px', fill: '#000', fontFamily: '"Arial"'}).setOrigin(0,0).setDepth(100).setScrollFactor(0);
		...
		/*this.matter.add.image(512, -1024, "wall", null, {isStatic: true}).setScale(2, 1).setAngle(90).setIgnoreGravity(true);
		this.matter.add.image(0, -1024, "wall", null, {isStatic: true}).setScale(2, 1).setAngle(90).setIgnoreGravity(true);
		this.matter.add.image(128, -1024, "wall", null, {isStatic: true}).setScale(2, 1).setAngle(90).setIgnoreGravity(true);
		//this.matter.add.image(256, -1024, "wall", null, {isStatic: true}).setScale(2, 1).setAngle(90).setIgnoreGravity(true);
		this.matter.add.image(384, -1024, "wall", null, {isStatic: true}).setScale(2, 1).setAngle(90).setIgnoreGravity(true);
		//this.matter.add.image(640, -1024, "wall", null, {isStatic: true}).setScale(2, 1).setAngle(90).setIgnoreGravity(true);
		this.matter.add.image(768, -1024, "wall", null, {isStatic: true}).setScale(2, 1).setAngle(90).setIgnoreGravity(true);
		
		this.matter.add.image(512, -1536, "wall", null, {isStatic: true}).setScale(2, 1).setIgnoreGravity(true);
		this.matter.add.image(225, -1750, "wall", null, {isStatic: true}).setScale(1, 1).setIgnoreGravity(true);
		
		this.matter.add.image(256, -2262, "wall", null, {isStatic: true}).setScale(2, 1).setIgnoreGravity(true);
		this.matter.add.image(512, -2600, "wall", null, {isStatic: true}).setScale(2, 1).setIgnoreGravity(true);
		this.matter.add.image(0, -2600, "wall", null, {isStatic: true}).setScale(1, 1).setIgnoreGravity(true);
		*/
		var rand = 0;
		var yPos = 0;
		...
		this.input.on('pointerdown', function(cursor) {
			...
			this.cameras.main.setBounds(0,-28000,450,29000);
